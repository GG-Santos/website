  ...
  return (
    <section id="drop">
      <div className="container">
        ...
        <div className="neoh_fn_drops">
          {items.length === 0 ? (
            <div style={{ padding: "40px 0", textAlign: "center", color: "#aaa" }}>
              <p>No game assets available yet.</p>
            </div>
          ) : (
          <ul>
        ...
        {/* View More Button */}
        <div className="custom-view-more-wrapper">
          <Link className="neoh_fn_button custom-view-more-button" href="/collection">
            <span className="text">View More Game Assets</span>
          </Link>
        </div>
